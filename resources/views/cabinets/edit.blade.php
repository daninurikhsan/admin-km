    ...
    <div class="col-6">
        <div class="pagetitle">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Edit Cabinet</li>
...
<div class="col-lg-12">
    ...
    <div class="card">
        <div class="card-body pt-3">
            <form action="/cabinet/{{ $cabinet->id }}" method="post" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name', $cabinet->name) }}">
                        @error('name')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('vision_statement') is-invalid @enderror" name="vision_statement" id="vision_statement" value="{{ old('vision_statement', $cabinet->vision_statement) }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control @error('start_date') is-invalid @enderror" name="start_date" id="start_date" value="{{ old('start_date', $cabinet->start_date) }}">
                        @error('start_date')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control @error('end_date') is-invalid @enderror" name="end_date" id="end_date" value="{{ old('end_date', $cabinet->end_date) }}">
                        @error('end_date')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
